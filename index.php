...
/*
ユーザーがログインしている場合に$memberにログインしているユーザーのレコードを格納
ログインしてない場合はlogin.phpに遷移
*/
...
$posts = $db->query('SELECT m.name, m.picture, p.* FROM members m,
